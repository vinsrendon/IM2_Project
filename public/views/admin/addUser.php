...
<body>    
    ...
    <div class="m-5 p-6 bg-white p-8 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <input disabled value=<?php echo ($_SESSION['lastsid'])+1; ?> type="text" id="sid" name="sid" placeholder="Auto generated by system" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" maxlength="8">
        </div>
